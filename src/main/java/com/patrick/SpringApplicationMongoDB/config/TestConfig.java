...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, fmt.parse("12/02/2024"), "Partiu viagem", "Vou viajar para São Paulo. Abraços", user1);
        Post post2 = new Post(null, fmt.parse("14/02/2024"), "Bom dia!", "Acordei feliz hoje.", user1);
